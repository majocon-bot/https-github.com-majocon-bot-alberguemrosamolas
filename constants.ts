...
export const ALL_ROOMS_DATA = [
    ...
    { number: 44, type: 'quad', typeName: 'Habitación Cuádruple', floor: '2°', description: '2 literas (4 huéspedes)' },
    { number: 46, type: 'quad', typeName: 'Habitación Cuádruple', floor: '2°', description: '2 literas (4 huéspedes)' },
    { number: 48, type: 'quad', typeName: 'Habitación Cuádruple', floor: '2°', description: '2 literas (4 huéspedes)' },
    // Doble (Capacity 2)
    { number: 21, type: 'double', typeName: 'Habitación Doble', floor: '1°', description: '2 camas (2 huéspedes)' },
    { number: 22, type: 'double', typeName: 'Habitación Doble', floor: '1°', description: '2 camas (2 huéspedes)' },
    { number: 45, type: 'double', typeName: 'Habitación Doble', floor: '2°', description: '2 camas (2 huéspedes)' },
    { number: 50, type: 'double', typeName: 'Habitación Doble', floor: '2°', description: '2 camas (2 huéspedes)' },
